classdef ReduceMeanLayer1023 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_07.coder.ReduceMeanLayer1023';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_5_83] = predict(this, x_blocks_blocks_5_77)
            ...
            x_blocks_blocks_5_77 = severity_net_epoch_07.ops.permuteInputVar(x_blocks_blocks_5_77, [4 3 1 2], 4);
            ...
            x_blocks_blocks_5_83 = severity_net_epoch_07.ops.permuteOutputVar(x_blocks_blocks_5_83, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_5_83, x_blocks_blocks_5_83NumDims1071] = ReduceMeanGraph1069(this, x_blocks_blocks_5_77, x_blocks_blocks_5_77NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_07.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1070, x_blocks_blocks_5_77NumDims);
