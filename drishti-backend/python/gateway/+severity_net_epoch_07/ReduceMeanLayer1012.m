classdef ReduceMeanLayer1012 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_07.coder.ReduceMeanLayer1012';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_3_68] = predict(this, x_blocks_blocks_3_62)
            ...
            x_blocks_blocks_3_62 = severity_net_epoch_07.ops.permuteInputVar(x_blocks_blocks_3_62, [4 3 1 2], 4);
            ...
            x_blocks_blocks_3_68 = severity_net_epoch_07.ops.permuteOutputVar(x_blocks_blocks_3_68, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_3_68, x_blocks_blocks_3_68NumDims1038] = ReduceMeanGraph1036(this, x_blocks_blocks_3_62, x_blocks_blocks_3_62NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_07.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1037, x_blocks_blocks_3_62NumDims);
