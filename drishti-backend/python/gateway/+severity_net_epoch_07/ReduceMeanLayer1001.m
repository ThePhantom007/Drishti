classdef ReduceMeanLayer1001 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_07.coder.ReduceMeanLayer1001';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_0_17] = predict(this, x_blocks_blocks_0_12)
            ...
            x_blocks_blocks_0_12 = severity_net_epoch_07.ops.permuteInputVar(x_blocks_blocks_0_12, [4 3 1 2], 4);
            ...
            x_blocks_blocks_0_17 = severity_net_epoch_07.ops.permuteOutputVar(x_blocks_blocks_0_17, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_0_17, x_blocks_blocks_0_17NumDims1005] = ReduceMeanGraph1003(this, x_blocks_blocks_0_12, x_blocks_blocks_0_12NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_07.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1004, x_blocks_blocks_0_12NumDims);
