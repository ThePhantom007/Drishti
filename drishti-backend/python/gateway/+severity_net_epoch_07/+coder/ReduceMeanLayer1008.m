classdef ReduceMeanLayer1008 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_07.coder.ReduceMeanLayer1008(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_07.ReduceMeanLayer1008(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_3__8] = predict(this, x_blocks_blocks_3__2__)
            ...
            x_blocks_blocks_3__2 = severity_net_epoch_07.coder.ops.permuteInputVar(x_blocks_blocks_3__2_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_3__8_ = severity_net_epoch_07.coder.ops.permuteOutputVar(x_blocks_blocks_3__8__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_3__8, x_blocks_blocks_3__8NumDims1026] = ReduceMeanGraph1024(this, x_blocks_blocks_3__2, x_blocks_blocks_3__2NumDims, Training)
            ...
            % ReduceMean:
            dims1016 = severity_net_epoch_07.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1025, coder.const(x_blocks_blocks_3__2NumDims));
