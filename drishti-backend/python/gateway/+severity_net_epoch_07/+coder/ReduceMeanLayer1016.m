classdef ReduceMeanLayer1016 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_07.coder.ReduceMeanLayer1016(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_07.ReduceMeanLayer1016(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_4_53] = predict(this, x_blocks_blocks_4_47__)
            ...
            x_blocks_blocks_4_47 = severity_net_epoch_07.coder.ops.permuteInputVar(x_blocks_blocks_4_47_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_4_53_ = severity_net_epoch_07.coder.ops.permuteOutputVar(x_blocks_blocks_4_53__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_4_53, x_blocks_blocks_4_53NumDims1050] = ReduceMeanGraph1048(this, x_blocks_blocks_4_47, x_blocks_blocks_4_47NumDims, Training)
            ...
            % ReduceMean:
            dims1032 = severity_net_epoch_07.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1049, coder.const(x_blocks_blocks_4_47NumDims));
