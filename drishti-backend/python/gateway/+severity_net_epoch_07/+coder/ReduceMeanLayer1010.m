classdef ReduceMeanLayer1010 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_07.coder.ReduceMeanLayer1010(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_07.ReduceMeanLayer1010(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_3_38] = predict(this, x_blocks_blocks_3_32__)
            ...
            x_blocks_blocks_3_32 = severity_net_epoch_07.coder.ops.permuteInputVar(x_blocks_blocks_3_32_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_3_38_ = severity_net_epoch_07.coder.ops.permuteOutputVar(x_blocks_blocks_3_38__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_3_38, x_blocks_blocks_3_38NumDims1032] = ReduceMeanGraph1030(this, x_blocks_blocks_3_32, x_blocks_blocks_3_32NumDims, Training)
            ...
            % ReduceMean:
            dims1020 = severity_net_epoch_07.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1031, coder.const(x_blocks_blocks_3_32NumDims));
