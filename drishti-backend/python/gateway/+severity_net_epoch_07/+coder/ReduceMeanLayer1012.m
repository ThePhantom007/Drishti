classdef ReduceMeanLayer1012 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_07.coder.ReduceMeanLayer1012(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_07.ReduceMeanLayer1012(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_3_68] = predict(this, x_blocks_blocks_3_62__)
            ...
            x_blocks_blocks_3_62 = severity_net_epoch_07.coder.ops.permuteInputVar(x_blocks_blocks_3_62_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_3_68_ = severity_net_epoch_07.coder.ops.permuteOutputVar(x_blocks_blocks_3_68__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_3_68, x_blocks_blocks_3_68NumDims1038] = ReduceMeanGraph1036(this, x_blocks_blocks_3_62, x_blocks_blocks_3_62NumDims, Training)
            ...
            % ReduceMean:
            dims1024 = severity_net_epoch_07.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1037, coder.const(x_blocks_blocks_3_62NumDims));
