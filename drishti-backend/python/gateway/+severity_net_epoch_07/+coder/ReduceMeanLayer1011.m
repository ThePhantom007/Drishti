classdef ReduceMeanLayer1011 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_07.coder.ReduceMeanLayer1011(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_07.ReduceMeanLayer1011(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_3_53] = predict(this, x_blocks_blocks_3_47__)
            ...
            x_blocks_blocks_3_47 = severity_net_epoch_07.coder.ops.permuteInputVar(x_blocks_blocks_3_47_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_3_53_ = severity_net_epoch_07.coder.ops.permuteOutputVar(x_blocks_blocks_3_53__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_3_53, x_blocks_blocks_3_53NumDims1035] = ReduceMeanGraph1033(this, x_blocks_blocks_3_47, x_blocks_blocks_3_47NumDims, Training)
            ...
            % ReduceMean:
            dims1022 = severity_net_epoch_07.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1034, coder.const(x_blocks_blocks_3_47NumDims));
