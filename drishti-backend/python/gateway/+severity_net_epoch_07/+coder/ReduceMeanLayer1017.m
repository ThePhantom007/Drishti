classdef ReduceMeanLayer1017 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_07.coder.ReduceMeanLayer1017(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_07.ReduceMeanLayer1017(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_4_68] = predict(this, x_blocks_blocks_4_62__)
            ...
            x_blocks_blocks_4_62 = severity_net_epoch_07.coder.ops.permuteInputVar(x_blocks_blocks_4_62_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_4_68_ = severity_net_epoch_07.coder.ops.permuteOutputVar(x_blocks_blocks_4_68__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_4_68, x_blocks_blocks_4_68NumDims1053] = ReduceMeanGraph1051(this, x_blocks_blocks_4_62, x_blocks_blocks_4_62NumDims, Training)
            ...
            % ReduceMean:
            dims1034 = severity_net_epoch_07.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1052, coder.const(x_blocks_blocks_4_62NumDims));
