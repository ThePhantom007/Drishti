classdef ReduceMeanLayer1016 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_11.coder.ReduceMeanLayer1016';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_4_53] = predict(this, x_blocks_blocks_4_47)
            ...
            x_blocks_blocks_4_47 = severity_net_epoch_11.ops.permuteInputVar(x_blocks_blocks_4_47, [4 3 1 2], 4);
            ...
            x_blocks_blocks_4_53 = severity_net_epoch_11.ops.permuteOutputVar(x_blocks_blocks_4_53, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_4_53, x_blocks_blocks_4_53NumDims1050] = ReduceMeanGraph1048(this, x_blocks_blocks_4_47, x_blocks_blocks_4_47NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_11.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1049, x_blocks_blocks_4_47NumDims);
