classdef ReduceMeanLayer1007 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_11.coder.ReduceMeanLayer1007';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_2_38] = predict(this, x_blocks_blocks_2_32)
            ...
            x_blocks_blocks_2_32 = severity_net_epoch_11.ops.permuteInputVar(x_blocks_blocks_2_32, [4 3 1 2], 4);
            ...
            x_blocks_blocks_2_38 = severity_net_epoch_11.ops.permuteOutputVar(x_blocks_blocks_2_38, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_2_38, x_blocks_blocks_2_38NumDims1023] = ReduceMeanGraph1021(this, x_blocks_blocks_2_32, x_blocks_blocks_2_32NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_11.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1022, x_blocks_blocks_2_32NumDims);
