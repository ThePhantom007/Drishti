classdef ReduceMeanLayer1018 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_11.coder.ReduceMeanLayer1018';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_5__8] = predict(this, x_blocks_blocks_5__2)
            ...
            x_blocks_blocks_5__2 = severity_net_epoch_11.ops.permuteInputVar(x_blocks_blocks_5__2, [4 3 1 2], 4);
            ...
            x_blocks_blocks_5__8 = severity_net_epoch_11.ops.permuteOutputVar(x_blocks_blocks_5__8, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_5__8, x_blocks_blocks_5__8NumDims1056] = ReduceMeanGraph1054(this, x_blocks_blocks_5__2, x_blocks_blocks_5__2NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_11.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1055, x_blocks_blocks_5__2NumDims);
