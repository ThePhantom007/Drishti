classdef ReduceMeanLayer1000 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_11.coder.ReduceMeanLayer1000(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_11.ReduceMeanLayer1000(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_0__5] = predict(this, x_blocks_blocks_0_bl__)
            ...
            x_blocks_blocks_0_bl = severity_net_epoch_11.coder.ops.permuteInputVar(x_blocks_blocks_0_bl_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_0__5_ = severity_net_epoch_11.coder.ops.permuteOutputVar(x_blocks_blocks_0__5__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_0__5, x_blocks_blocks_0__5NumDims1002] = ReduceMeanGraph1000(this, x_blocks_blocks_0_bl, x_blocks_blocks_0_blNumDims, Training)
            ...
            % ReduceMean:
            dims1000 = severity_net_epoch_11.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1001, coder.const(x_blocks_blocks_0_blNumDims));
