classdef ReduceMeanLayer1001 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_11.coder.ReduceMeanLayer1001(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_11.ReduceMeanLayer1001(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_0_17] = predict(this, x_blocks_blocks_0_12__)
            ...
            x_blocks_blocks_0_12 = severity_net_epoch_11.coder.ops.permuteInputVar(x_blocks_blocks_0_12_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_0_17_ = severity_net_epoch_11.coder.ops.permuteOutputVar(x_blocks_blocks_0_17__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_0_17, x_blocks_blocks_0_17NumDims1005] = ReduceMeanGraph1003(this, x_blocks_blocks_0_12, x_blocks_blocks_0_12NumDims, Training)
            ...
            % ReduceMean:
            dims1002 = severity_net_epoch_11.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1004, coder.const(x_blocks_blocks_0_12NumDims));
