classdef ReduceMeanLayer1025 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_11.coder.ReduceMeanLayer1025(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_11.ReduceMeanLayer1025(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_6_23] = predict(this, x_blocks_blocks_6_17__)
            ...
            x_blocks_blocks_6_17 = severity_net_epoch_11.coder.ops.permuteInputVar(x_blocks_blocks_6_17_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_6_23_ = severity_net_epoch_11.coder.ops.permuteOutputVar(x_blocks_blocks_6_23__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_6_23, x_blocks_blocks_6_23NumDims1077] = ReduceMeanGraph1075(this, x_blocks_blocks_6_17, x_blocks_blocks_6_17NumDims, Training)
            ...
            % ReduceMean:
            dims1050 = severity_net_epoch_11.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1076, coder.const(x_blocks_blocks_6_17NumDims));
