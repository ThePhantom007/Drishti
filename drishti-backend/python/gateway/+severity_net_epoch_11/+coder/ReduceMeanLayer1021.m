classdef ReduceMeanLayer1021 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_11.coder.ReduceMeanLayer1021(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_11.ReduceMeanLayer1021(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_5_53] = predict(this, x_blocks_blocks_5_47__)
            ...
            x_blocks_blocks_5_47 = severity_net_epoch_11.coder.ops.permuteInputVar(x_blocks_blocks_5_47_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_5_53_ = severity_net_epoch_11.coder.ops.permuteOutputVar(x_blocks_blocks_5_53__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_5_53, x_blocks_blocks_5_53NumDims1065] = ReduceMeanGraph1063(this, x_blocks_blocks_5_47, x_blocks_blocks_5_47NumDims, Training)
            ...
            % ReduceMean:
            dims1042 = severity_net_epoch_11.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1064, coder.const(x_blocks_blocks_5_47NumDims));
