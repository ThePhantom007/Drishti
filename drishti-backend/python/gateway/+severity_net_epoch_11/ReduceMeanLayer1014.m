classdef ReduceMeanLayer1014 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_11.coder.ReduceMeanLayer1014';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_4_23] = predict(this, x_blocks_blocks_4_17)
            ...
            x_blocks_blocks_4_17 = severity_net_epoch_11.ops.permuteInputVar(x_blocks_blocks_4_17, [4 3 1 2], 4);
            ...
            x_blocks_blocks_4_23 = severity_net_epoch_11.ops.permuteOutputVar(x_blocks_blocks_4_23, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_4_23, x_blocks_blocks_4_23NumDims1044] = ReduceMeanGraph1042(this, x_blocks_blocks_4_17, x_blocks_blocks_4_17NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_11.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1043, x_blocks_blocks_4_17NumDims);
