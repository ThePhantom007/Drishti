classdef ReduceMeanLayer1025 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_10.coder.ReduceMeanLayer1025';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_6_23] = predict(this, x_blocks_blocks_6_17)
            ...
            x_blocks_blocks_6_17 = severity_net_epoch_10.ops.permuteInputVar(x_blocks_blocks_6_17, [4 3 1 2], 4);
            ...
            x_blocks_blocks_6_23 = severity_net_epoch_10.ops.permuteOutputVar(x_blocks_blocks_6_23, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_6_23, x_blocks_blocks_6_23NumDims1077] = ReduceMeanGraph1075(this, x_blocks_blocks_6_17, x_blocks_blocks_6_17NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_10.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1076, x_blocks_blocks_6_17NumDims);
