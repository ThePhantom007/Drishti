classdef ReduceMeanLayer1022 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_10.coder.ReduceMeanLayer1022';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_5_68] = predict(this, x_blocks_blocks_5_62)
            ...
            x_blocks_blocks_5_62 = severity_net_epoch_10.ops.permuteInputVar(x_blocks_blocks_5_62, [4 3 1 2], 4);
            ...
            x_blocks_blocks_5_68 = severity_net_epoch_10.ops.permuteOutputVar(x_blocks_blocks_5_68, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_5_68, x_blocks_blocks_5_68NumDims1068] = ReduceMeanGraph1066(this, x_blocks_blocks_5_62, x_blocks_blocks_5_62NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_10.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1067, x_blocks_blocks_5_62NumDims);
