classdef ReduceMeanLayer1000 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_10.coder.ReduceMeanLayer1000';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_0__5] = predict(this, x_blocks_blocks_0_bl)
            ...
            x_blocks_blocks_0_bl = severity_net_epoch_10.ops.permuteInputVar(x_blocks_blocks_0_bl, [4 3 1 2], 4);
            ...
            x_blocks_blocks_0__5 = severity_net_epoch_10.ops.permuteOutputVar(x_blocks_blocks_0__5, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_0__5, x_blocks_blocks_0__5NumDims1002] = ReduceMeanGraph1000(this, x_blocks_blocks_0_bl, x_blocks_blocks_0_blNumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_10.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1001, x_blocks_blocks_0_blNumDims);
