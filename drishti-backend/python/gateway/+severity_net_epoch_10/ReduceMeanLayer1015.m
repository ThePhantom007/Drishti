classdef ReduceMeanLayer1015 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_10.coder.ReduceMeanLayer1015';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_4_38] = predict(this, x_blocks_blocks_4_32)
            ...
            x_blocks_blocks_4_32 = severity_net_epoch_10.ops.permuteInputVar(x_blocks_blocks_4_32, [4 3 1 2], 4);
            ...
            x_blocks_blocks_4_38 = severity_net_epoch_10.ops.permuteOutputVar(x_blocks_blocks_4_38, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_4_38, x_blocks_blocks_4_38NumDims1047] = ReduceMeanGraph1045(this, x_blocks_blocks_4_32, x_blocks_blocks_4_32NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_10.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1046, x_blocks_blocks_4_32NumDims);
