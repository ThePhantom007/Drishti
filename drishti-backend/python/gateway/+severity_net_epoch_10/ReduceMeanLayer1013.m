classdef ReduceMeanLayer1013 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_10.coder.ReduceMeanLayer1013';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_4__8] = predict(this, x_blocks_blocks_4__2)
            ...
            x_blocks_blocks_4__2 = severity_net_epoch_10.ops.permuteInputVar(x_blocks_blocks_4__2, [4 3 1 2], 4);
            ...
            x_blocks_blocks_4__8 = severity_net_epoch_10.ops.permuteOutputVar(x_blocks_blocks_4__8, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_4__8, x_blocks_blocks_4__8NumDims1041] = ReduceMeanGraph1039(this, x_blocks_blocks_4__2, x_blocks_blocks_4__2NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_10.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1040, x_blocks_blocks_4__2NumDims);
