classdef ReduceMeanLayer1017 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_10.coder.ReduceMeanLayer1017';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_4_68] = predict(this, x_blocks_blocks_4_62)
            ...
            x_blocks_blocks_4_62 = severity_net_epoch_10.ops.permuteInputVar(x_blocks_blocks_4_62, [4 3 1 2], 4);
            ...
            x_blocks_blocks_4_68 = severity_net_epoch_10.ops.permuteOutputVar(x_blocks_blocks_4_68, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_4_68, x_blocks_blocks_4_68NumDims1053] = ReduceMeanGraph1051(this, x_blocks_blocks_4_62, x_blocks_blocks_4_62NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_10.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1052, x_blocks_blocks_4_62NumDims);
