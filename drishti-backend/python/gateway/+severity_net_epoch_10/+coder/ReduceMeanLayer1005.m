classdef ReduceMeanLayer1005 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_10.coder.ReduceMeanLayer1005(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_10.ReduceMeanLayer1005(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_2__8] = predict(this, x_blocks_blocks_2__2__)
            ...
            x_blocks_blocks_2__2 = severity_net_epoch_10.coder.ops.permuteInputVar(x_blocks_blocks_2__2_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_2__8_ = severity_net_epoch_10.coder.ops.permuteOutputVar(x_blocks_blocks_2__8__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_2__8, x_blocks_blocks_2__8NumDims1017] = ReduceMeanGraph1015(this, x_blocks_blocks_2__2, x_blocks_blocks_2__2NumDims, Training)
            ...
            % ReduceMean:
            dims1010 = severity_net_epoch_10.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1016, coder.const(x_blocks_blocks_2__2NumDims));
