classdef ReduceMeanLayer1004 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_10.coder.ReduceMeanLayer1004(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_10.ReduceMeanLayer1004(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_1_38] = predict(this, x_blocks_blocks_1_32__)
            ...
            x_blocks_blocks_1_32 = severity_net_epoch_10.coder.ops.permuteInputVar(x_blocks_blocks_1_32_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_1_38_ = severity_net_epoch_10.coder.ops.permuteOutputVar(x_blocks_blocks_1_38__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_1_38, x_blocks_blocks_1_38NumDims1014] = ReduceMeanGraph1012(this, x_blocks_blocks_1_32, x_blocks_blocks_1_32NumDims, Training)
            ...
            % ReduceMean:
            dims1008 = severity_net_epoch_10.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1013, coder.const(x_blocks_blocks_1_32NumDims));
