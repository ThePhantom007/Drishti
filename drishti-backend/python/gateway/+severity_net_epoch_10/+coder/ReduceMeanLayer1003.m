classdef ReduceMeanLayer1003 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net_epoch_10.coder.ReduceMeanLayer1003(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net_epoch_10.ReduceMeanLayer1003(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_1_23] = predict(this, x_blocks_blocks_1_17__)
            ...
            x_blocks_blocks_1_17 = severity_net_epoch_10.coder.ops.permuteInputVar(x_blocks_blocks_1_17_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_1_23_ = severity_net_epoch_10.coder.ops.permuteOutputVar(x_blocks_blocks_1_23__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_1_23, x_blocks_blocks_1_23NumDims1011] = ReduceMeanGraph1009(this, x_blocks_blocks_1_17, x_blocks_blocks_1_17NumDims, Training)
            ...
            % ReduceMean:
            dims1006 = severity_net_epoch_10.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1010, coder.const(x_blocks_blocks_1_17NumDims));
