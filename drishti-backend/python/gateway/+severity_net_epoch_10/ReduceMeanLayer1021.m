classdef ReduceMeanLayer1021 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net_epoch_10.coder.ReduceMeanLayer1021';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_5_53] = predict(this, x_blocks_blocks_5_47)
            ...
            x_blocks_blocks_5_47 = severity_net_epoch_10.ops.permuteInputVar(x_blocks_blocks_5_47, [4 3 1 2], 4);
            ...
            x_blocks_blocks_5_53 = severity_net_epoch_10.ops.permuteOutputVar(x_blocks_blocks_5_53, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_5_53, x_blocks_blocks_5_53NumDims1065] = ReduceMeanGraph1063(this, x_blocks_blocks_5_47, x_blocks_blocks_5_47NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net_epoch_10.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1064, x_blocks_blocks_5_47NumDims);
