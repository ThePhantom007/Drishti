classdef ReduceMeanLayer1010 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'severity_net.coder.ReduceMeanLayer1010';
        end
    end
    ...
    methods
        ...
        function [x_blocks_blocks_3_38] = predict(this, x_blocks_blocks_3_32)
            ...
            x_blocks_blocks_3_32 = severity_net.ops.permuteInputVar(x_blocks_blocks_3_32, [4 3 1 2], 4);
            ...
            x_blocks_blocks_3_38 = severity_net.ops.permuteOutputVar(x_blocks_blocks_3_38, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_3_38, x_blocks_blocks_3_38NumDims1032] = ReduceMeanGraph1030(this, x_blocks_blocks_3_32, x_blocks_blocks_3_32NumDims, Training)
            ...
            % ReduceMean:
            dims = severity_net.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1031, x_blocks_blocks_3_32NumDims);
