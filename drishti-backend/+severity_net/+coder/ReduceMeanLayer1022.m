classdef ReduceMeanLayer1022 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net.coder.ReduceMeanLayer1022(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net.ReduceMeanLayer1022(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_5_68] = predict(this, x_blocks_blocks_5_62__)
            ...
            x_blocks_blocks_5_62 = severity_net.coder.ops.permuteInputVar(x_blocks_blocks_5_62_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_5_68_ = severity_net.coder.ops.permuteOutputVar(x_blocks_blocks_5_68__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_5_68, x_blocks_blocks_5_68NumDims1068] = ReduceMeanGraph1066(this, x_blocks_blocks_5_62, x_blocks_blocks_5_62NumDims, Training)
            ...
            % ReduceMean:
            dims1044 = severity_net.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1067, coder.const(x_blocks_blocks_5_62NumDims));
