classdef ReduceMeanLayer1023 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net.coder.ReduceMeanLayer1023(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net.ReduceMeanLayer1023(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_5_83] = predict(this, x_blocks_blocks_5_77__)
            ...
            x_blocks_blocks_5_77 = severity_net.coder.ops.permuteInputVar(x_blocks_blocks_5_77_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_5_83_ = severity_net.coder.ops.permuteOutputVar(x_blocks_blocks_5_83__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_5_83, x_blocks_blocks_5_83NumDims1071] = ReduceMeanGraph1069(this, x_blocks_blocks_5_77, x_blocks_blocks_5_77NumDims, Training)
            ...
            % ReduceMean:
            dims1046 = severity_net.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1070, coder.const(x_blocks_blocks_5_77NumDims));
