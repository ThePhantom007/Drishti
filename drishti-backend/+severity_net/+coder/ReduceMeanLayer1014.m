classdef ReduceMeanLayer1014 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function this_cg = matlabCodegenToRedirected(mlInstance)
            this_cg = severity_net.coder.ReduceMeanLayer1014(mlInstance);
        end
        function this_ml = matlabCodegenFromRedirected(cgInstance)
            this_ml = severity_net.ReduceMeanLayer1014(cgInstance.Name);
    ...
    methods
        ...
        function [x_blocks_blocks_4_23] = predict(this, x_blocks_blocks_4_17__)
            ...
            x_blocks_blocks_4_17 = severity_net.coder.ops.permuteInputVar(x_blocks_blocks_4_17_, [4 3 1 2], 4);
            ...
            x_blocks_blocks_4_23_ = severity_net.coder.ops.permuteOutputVar(x_blocks_blocks_4_23__, [3 4 2 1], 4);
        ...
        function [x_blocks_blocks_4_23, x_blocks_blocks_4_23NumDims1044] = ReduceMeanGraph1042(this, x_blocks_blocks_4_17, x_blocks_blocks_4_17NumDims, Training)
            ...
            % ReduceMean:
            dims1028 = severity_net.coder.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1043, coder.const(x_blocks_blocks_4_17NumDims));
